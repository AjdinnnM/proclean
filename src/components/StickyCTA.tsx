...
export function StickyCTA() {
  ...
  return (
    <>
      ...
      >
        <div className="bg-white border-t border-gray-100 shadow-[0_-8px_30px_-10px_rgba(0,0,0,0.15)] px-3 py-3 flex items-center gap-2">
          <a
            href="tel:+385994840416"
            className="shrink-0 inline-flex items-center justify-center h-12 w-12 rounded-full border border-gray-200 bg-white text-[var(--color-brand-700)]"
            aria-label="Nazovi"
          >
          ...
          <a
            href="/kontakt"
            className="flex-1 inline-flex items-center justify-center gap-2 h-12 rounded-full bg-[var(--color-brand-600)] text-white font-semibold text-[14px]"
          >
            Zatraži ponudu
