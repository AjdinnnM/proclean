      ...
      <div className="max-w-[1200px] mx-auto px-6 lg:px-10">
        <div className="grid lg:grid-cols-12 gap-10 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-6 relative">
            ...
            {/* Subtle floating credential card */}
            <div className="absolute -bottom-6 -right-6 lg:-right-12 max-w-[260px] bg-white text-[#0A0A0A] rounded-[16px] p-5 shadow-[0_20px_60px_-20px_rgba(0,0,0,0.4)] hidden sm:block">
              <p className="text-[11px] uppercase tracking-[0.18em] text-[#6B7280] mb-2">Aktivno održavamo</p>
              <p
              ...
              <p className="text-[12px] text-[#3F3F3F] mt-1">u Zagrebu i okolici</p>
            </div>
          </div>
