...
export function StickyCTAv2() {
  ...
  return (
    <>
      ...
      >
        <div className="bg-white border-t border-black/10 shadow-[0_-8px_30px_-10px_rgba(0,0,0,0.15)] px-3 py-3 flex items-center gap-2">
          <a
            href="tel:+385994840416"
            className="shrink-0 inline-flex items-center justify-center h-12 w-12 rounded-full border border-black/10 bg-white text-[#0A0A0A]"
            aria-label="Nazovi"
          >
          ...
          <a
            href="#kontakt"
            className="flex-1 inline-flex items-center justify-center gap-2 h-12 rounded-full bg-[#0A0A0A] text-white font-medium text-[14px]"
          >
            Zatraži ponudu
