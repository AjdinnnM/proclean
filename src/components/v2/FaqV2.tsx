const FAQ = [
  {
    q: "Koliko košta čišćenje?",
    a: "Cijena ovisi o površini, učestalosti i specifičnim zahtjevima. Za stambene zajednice nudimo besplatno probno čišćenje prije ugovora. Pošalji upit i odgovaramo s konkretnom ponudom unutar 2 sata.",
  },
  {
    q: "Tko sve može biti klijent?",
    a: "Stambene zajednice, upravitelji zgrada, tvrtke, hoteli, butici, kao i privatni korisnici. Radimo i jednokratne i kontinuirane angažmane.",
  },
  {
    q: "Izdajete li R1 račun?",
    a: "Da, R1 račun za pravna lica izdajemo bez dodatnih troškova. Tako pravne osobe i stambene zajednice imaju potpuno transparentan račun za knjigovodstvo.",
  },
  {
    q: "Koja sredstva koristite?",
    a: "100% biorazgradiva, ekološka sredstva — sigurna za stanare, kućne ljubimce i okoliš. Posebne tretmane za masnoće, kamenac i mrlje provodimo profesionalnim koncentratima.",
  },
  {
    q: "Koliko brzo dolazite na termin?",
    a: "Odgovor na upit šaljemo unutar 2 sata radnim danom. Termin se u pravilu dogovara unutar 7 dana od potvrde ponude — hitno i unutar 48h.",
  },
  {
    q: "Što ako nisam zadovoljan rezultatom?",
    a: "Vraćamo se i ponavljamo posao bez dodatnih troškova. Naš standard je da te ljudi pitaju tko je radio — ako to nismo postigli, ispravljamo.",
  },
];
    ...
    <section className="bg-white py-20 lg:py-32">
      <div className="max-w-[920px] mx-auto px-6 lg:px-10">
        ...
        <div className="mt-14 text-center">
          ...
          <a
            href="#kontakt"
            className="inline-flex items-center gap-2 text-[15px] font-medium text-[#0A0A0A] underline underline-offset-4 hover:opacity-70 transition-opacity"
          >
